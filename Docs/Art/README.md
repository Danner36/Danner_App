...
- Row 2: YouTube TV under Guardians, then a same-size reserved empty spacer
...
- `app/assets/new-england-patriots-logo.jpg` is the bundled Flying Elvis mark from ESPN's Patriots team artwork.
