...
import { CYCLONES_TEAM_ID } from './cyclonesSnapshot';
import type { LiveFootballScoreboard } from './espnCyclonesScoreboard';
...
export function CyclonesFootballScoreboard({
  isHome,
  opponentName,
  scoreboard,
}: {
  ...
  const possessionIsHome =
    scoreboard.possessionTeamId === undefined
      ? undefined
      : isHome
        ? scoreboard.possessionTeamId === CYCLONES_TEAM_ID
        : scoreboard.possessionTeamId !== CYCLONES_TEAM_ID;
