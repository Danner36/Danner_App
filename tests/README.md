...
- `cyclones/` simulates today, video-ready, delayed, live, and Final recap Iowa State states plus Get video on port 8113. `run-snapshot.mjs` checks featured-card selection across sports, regular-season records, Chicago official dates, and elimination versus awaiting-next.
